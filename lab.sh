...
show_urls() {
    ...
    echo "Joomla:              http://localhost:8085"
    echo ""
    echo -e "${GREEN}=== DevOps Tools ===${NC}"
    echo "Tomcat:              http://localhost:8086"
    echo "Jenkins:             http://localhost:8087"
    echo "Grafana:             http://localhost:3001"
    echo "ElasticSearch:       http://localhost:9200"
    echo ""
    echo -e "${GREEN}=== OWASP Vulnerable Apps ===${NC}"
    echo "OWASP VulnerableApp: http://localhost:8090"
    ...
    echo "VulnBank:            http://localhost:8097"
    echo "VulnLab:             http://localhost:8098"
    echo "OWASP WrongSecrets:  http://localhost:8099"
    echo "Yrprey:              http://localhost:8100"
    echo "Zero Health:         http://localhost:8101"
    echo ""
    echo -e "${GREEN}=== API & Services ===${NC}"
    echo "VulnAPI:             http://localhost:8102"
    echo "DVWS:                http://localhost:8103"
    echo "Hackazon:            http://localhost:8104"
    echo "Padding Oracle:      http://localhost:8105"
    echo "VulnShop:            http://localhost:8106"
    echo ""
    echo -e "${GREEN}=== Network Services ===${NC}"
    echo "FTP (VSFTPD):        localhost:21"
    echo "FTP (ProFTPD):       localhost:2121"
