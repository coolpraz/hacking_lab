...
show_urls() {
    ...
    # echo "Pixi (XSS):          http://localhost:8094  # REMOVED: Image no longer available (use Juice Shop for XSS practice)"
    echo "PyGoat:              http://localhost:8095"
    # echo "SSRF Lab:            http://localhost:8096  # REMOVED: Image no longer available"
    echo "OWASP WrongSecrets:  http://localhost:8099"
    # echo "Hackazon:            http://localhost:8104  # REMOVED: Image no longer available"
    # echo "VulnShop:            http://localhost:8106  # REMOVED: Image no longer available (use Damn Vuln Restaurant for business logic flaws)"
    echo ""
